...
create or replace view article_unchecked_info
(article_id, author_id, editor_id, module_id, article_title, article_intro, add_time, cover_link, author_name, author_avatar_link, like_num)
as
select a.article_id, a.author_id, a.editor_id, a.module_id, a.article_title, a.article_intro, a.add_time, cover_link, au.user_name, au.user_avatar_link, count(u.like_id) from article_unchecked as a left join user as au on a.author_id = au.user_id left join user_like_article as u on a.article_id = u.article_id group by a.article_id;
...
create or replace view author_apply_info
