...
@Entity
@Table(name = "article_unchecked_info", schema = "yhl", catalog = "")
public class ArticleUncheckedInfoEntity {
    ...
    public boolean equals(Object o) {
        ...
        ArticleUncheckedInfoEntity that = (ArticleUncheckedInfoEntity) o;
