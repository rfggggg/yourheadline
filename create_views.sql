...
as
select a.article_id, a.author_id, a.editor_id, a.module_id, a.article_title, a.article_intro, a.add_time, au.author_name, au.author_avatar_link, count(u.like_id) from article as a left join author as au on a.author_id = au.author_id left join user_like_article as u on a.article_id = u.article_id group by a.article_id;
